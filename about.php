        ...
        <!-- Slide2 -->
                ...
                <div class="row">
                        ...
                        <div style="width: 432px; height: 500px">
                            <img style="margin-left: 20px; border-radius: 200px; width: 90%" src="assets/img/avt01.jpg" alt="IMG-PRODUCT"/>
                    
                            <h5 class="text-center" style="margin-top:20px">Đỗ Vũ Dũng</h5>
                          
                            <h5 class="text-center">20194520</h5>
                        </div>
                        <div style="width:432px; height: 500px">
                            <img style="margin-left:20px; border-radius: 200px; width: 90%" src="assets/img/avt01.jpg" alt="IMG-PRODUCT"/>
                          
                            <h5 class="text-center" style="margin-top:20px">Nguyễn Tiến Dũng</h5>
                          
                            <h5 class="text-center">20194524</h5>
                        </div>
                        <div style="width: 432px; height: 500px">
                            <img style="margin-left: 20px; border-radius: 200px; width: 90%" src="assets/img/avt01.jpg" alt="IMG-PRODUCT"/>
                           
                            <h5 class="text-center" style="margin-top:20px">Phạm Huy Cảnh</h5>
                    ...
                    <div style="width: 432px; height: 500px">
                        ...
                        <h5 class="text-center" style="margin-top:20px">Vũ Tài Công</h5>

                        <h5 class="text-center">20194496</h5>
                    </div>
                    <div style="width: 432px; height: 500px">
                        <img style="margin-left: 20px; border-radius: 200px; width: 90%" src="assets/img/avt01.jpg" alt="IMG-PRODUCT"/>

                        <h5 class="text-center" style="margin-top:20px">Quách Văn Hoá</h5>

                        <h5 class="text-center">20194564</h5>
                    </div>
                </div>
  </div>
